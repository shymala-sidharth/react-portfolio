    ...
    <div className={darkMode ? 'dark' : ''}>
      ...
      <main className='bg-purple-100 dark:bg-purple-900'>
        <section>
          ...
          <nav className='py-5 mb-12 flex justify-end'>
            ...
            <ul className='container px-5 mx-auto flex flex-wrap justify-end'>
              ...
              <li><a className='bg-gradient-to-r from-purple-600 to-pink-500 text-white px-6 py-1 rounded ml-8' href="https://drive.google.com/file/d/1ZIR0Kk3gqkLgXpVU9QLfq5Ggkrnv0EGE/preview" target='_blank' rel='noreferrer'>RESUME</a> 
              </li>
        ...
        <section>
            ...
            <h3 className='text-center text-6xl font-semibold font-Amiko text-purple-700 dark:text-pink-500' id='Projects'>P R O J E C T S</h3>
